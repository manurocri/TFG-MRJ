  ...
  <main>
    ...
    <div class="row g-5">
      <div class="col-md-6">
        ...
        <ul class="icon-list">
          <li><a href="../templatesAyuda/enviosGratuitos.php" class="text-white">¿Cómo puedo obtener envíos gratuitos?</a></li>
      ...
      <div class="col-md-6">
        ...
        <li><a href="../templatesAyuda/devolverJuego.php" class="text-white">¿Cómo puedo devolver mi juego?</a></li>
      ...
      <div class="col-md-6">
        ...
        <ul class="icon-list">
          <li><a href="../templatesAyuda/dondeEstaMiJuego.php" class="text-white">¿Política de compra?</a></li>
      ...
      <div class="col-md-6">
        ...
        <ul class="icon-list">
        <li><a href="../templatesAyuda/ultimosLanzamientos.php" class="text-white">¿Cómo puedo conseguir los últimos lanzamientos?</a></li>
