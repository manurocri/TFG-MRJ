  ...
  <div class="row justify-content-center align-items-center">
    ...
    <div class="col-sm-2">
      ...
      <ul class="col-3 list-unstyled col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="" class="text-reset colorgristexto">Juegos</a></li>
        <li><a href="" class="text-reset colorgristexto">Suscripciones</a></li>
        <li><a href="" class="text-reset colorgristexto">Condiciones de suscripcion</a></li>
