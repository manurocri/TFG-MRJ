      ...
      <div class="row py-2">
        <div class="col-12 col-md text-center text-md-start ">
          <span class="text-white">
            ...
            cargar imágenes y vídeos. Antes de aceptarlas te invitamos a leer nuestra <a class="text-decoration-none naranjilla linksoscuros" href="./templatesAyuda/cookies.php">política de cookies</a>.
          </span>
        </div>
