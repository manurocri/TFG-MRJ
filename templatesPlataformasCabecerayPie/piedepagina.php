  ...
  <div class="row justify-content-center align-items-center">
    ...
    <div class="col-sm-2">
      ...
      <ul class="col-3 list-unstyled col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="../templatesAyuda/ayuda.php" class="text-reset colorgristexto">Ayuda</a></li>
    ...
    <div class="col-sm-2 ">
      ...
      <ul class="col-3 list-unstyled col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0 pl-5">

        <li class="font-weight-bold text-uppercase naranjilla px-5">Aplicación</li>
