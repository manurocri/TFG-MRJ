...
<div class="container px-4 pt-5" id="custom-cards">
            ...
            <ul class="d-flex list-unstyled mt-auto">
              ...
              <div class="row">
                ...
                while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
                  foreach ($fila as $f) {
                    if ($f < 1) {
                      echo '<div class="col"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-xbox naranjilla" viewBox="0 0 16 16">
  ...
  <div class="container px-4" id="custom-cards">
    ...
    <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
      ...
      require '../includes/dbh.inc.php';
      $stmt = mysqli_stmt_init($conn);
      $sql = "SELECT cantidad FROM productos WHERE id=60";
      mysqli_stmt_prepare($stmt, $sql);
      mysqli_stmt_execute($stmt);
      $resultado = mysqli_stmt_get_result($stmt);
      while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
        foreach ($fila as $f) {
          ...
          if (isset($_SESSION["userId"])) {
            if ($f > 0 || $_SESSION["userId"] == 1) {
              echo '<a href="../templatesJuegos/juegoXbox.php?lang=es&idJ=60" style="text-decoration: none;">';
            } else if ($f < 1) {
              echo '<a>';
            };
          } else if ($f > 0) {
        ...
        <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" style="background-image: url('../img/Xbox/Halo.jpg'); ">
          <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
            <h2 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold"></h2>
            <ul class="d-flex list-unstyled mt-auto">
              <li class="me-auto">
      ...
      require '../includes/dbh.inc.php';
      $stmt = mysqli_stmt_init($conn);
      $sql = "SELECT cantidad FROM productos WHERE id=61";
      mysqli_stmt_prepare($stmt, $sql);
      mysqli_stmt_execute($stmt);
      $resultado = mysqli_stmt_get_result($stmt);
      while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
        foreach ($fila as $f) {
          ...
          if (isset($_SESSION["userId"])) {
            if ($f > 0 || $_SESSION["userId"] == 1) {
              echo '<a href="../templatesJuegos/juegoXbox.php?lang=es&idJ=61" style="text-decoration: none;">';
            } else if ($f < 1) {
              echo '<a>';
            };
          } else if ($f > 0) {
        ...
        <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" style="background-image: url('../img/Xbox/Forza.jpg');">
          <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
            <h2 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold"></h2>
            <ul class="d-flex list-unstyled mt-auto">
            <li class="me-auto">
      ...
      require '../includes/dbh.inc.php';
      $stmt = mysqli_stmt_init($conn);
      $sql = "SELECT cantidad FROM productos WHERE id=62";
      mysqli_stmt_prepare($stmt, $sql);
      mysqli_stmt_execute($stmt);
      $resultado = mysqli_stmt_get_result($stmt);
      while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
        foreach ($fila as $f) {
          ...
          if (isset($_SESSION["userId"])) {
            if ($f > 0 || $_SESSION["userId"] == 1) {
              echo '<a href="../templatesJuegos/juegoXbox.php?lang=es&idJ=62" style="text-decoration: none;">';
            } else if ($f < 1) {
              echo '<a>';
            };
          } else if ($f > 0) {
        ...
        <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" style="background-image: url('../img/Xbox/sea.jpg');">
          <div class="d-flex flex-column h-100 p-5 pb-3 text-shadow-1">
            <h2 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold"></h2>
            <ul class="d-flex list-unstyled mt-auto">
            <li class="me-auto">
