...
<div class="container px-4 pt-5" id="custom-cards">
  ...
  <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
    ...
    <div class="col">
      <a href="../templatesJuegos/juegoPlayStation.php?lang=es&idJ=42" style="text-decoration: none;">
            ...
            <ul class="d-flex list-unstyled mt-auto">
              ...
              <li class="d-flex align-items-center me-3">
                ...
                <?php
                  ...
                  $sql = "SELECT nombrejuego FROM productos WHERE id=42";
              ...
              <li class="d-flex align-items-center">
                <small class="bg-dark text-white rounded-5"><?php
                          ...
                          require '../includes/dbh.inc.php';
                          $stmt = mysqli_stmt_init($conn);
                          $sql = "SELECT precio FROM productos WHERE id=42";
  ...
  <div class="col">
    <a href="../templatesJuegos/juegoPlayStation.php?lang=es&idJ=38" style="text-decoration: none;">
          ...
          <ul class="d-flex list-unstyled mt-auto">
            ...
            <li class="d-flex align-items-center me-3">
              ...
              <?php
                  require '../includes/dbh.inc.php';
                  $stmt = mysqli_stmt_init($conn);
                  $sql = "SELECT nombrejuego FROM productos WHERE id=38";
                  mysqli_stmt_prepare($stmt, $sql);
                  mysqli_stmt_execute($stmt);
                  $resultado = mysqli_stmt_get_result($stmt);
                  while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
            ...
            <li class="d-flex align-items-center">
              <small class="bg-dark text-white rounded-5"><?php
                          ...
                          require '../includes/dbh.inc.php';
                          $stmt = mysqli_stmt_init($conn);
                          $sql = "SELECT precio FROM productos WHERE id=38";
...
<div class="col">
  <a href="../templatesJuegos/juegoPlayStation.php?lang=es&idJ=45" style="text-decoration: none;">
        ...
        <ul class="d-flex list-unstyled mt-auto">
          ...
          <li class="d-flex align-items-center me-3">
            ...
            <?php
                  require '../includes/dbh.inc.php';
                  $stmt = mysqli_stmt_init($conn);
                  $sql = "SELECT nombrejuego FROM productos WHERE id=45";
                  mysqli_stmt_prepare($stmt, $sql);
                  mysqli_stmt_execute($stmt);
                  $resultado = mysqli_stmt_get_result($stmt);
                  while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
          ...
          <li class="d-flex align-items-center">
            <small class="bg-dark text-white rounded-5"><?php
                          ...
                          require '../includes/dbh.inc.php';
                          $stmt = mysqli_stmt_init($conn);
                          $sql = "SELECT precio FROM productos WHERE id=45";
...
<div class="container px-4" id="custom-cards">
  ...
  <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
    <div class="col">
      <a href="../templatesJuegos/juegoPlayStation.php?lang=es&idJ=47" style="text-decoration: none;">
            ...
            <ul class="d-flex list-unstyled mt-auto">
              ...
              <li class="d-flex align-items-center me-3">
                ...
                <?php
                  require '../includes/dbh.inc.php';
                  $stmt = mysqli_stmt_init($conn);
                  $sql = "SELECT nombrejuego FROM productos WHERE id=47";
                  mysqli_stmt_prepare($stmt, $sql);
                  mysqli_stmt_execute($stmt);
                  $resultado = mysqli_stmt_get_result($stmt);
                  while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
              ...
              <li class="d-flex align-items-center">
                <small class="bg-dark text-white rounded-5"><?php
                          ...
                          require '../includes/dbh.inc.php';
                          $stmt = mysqli_stmt_init($conn);
                          $sql = "SELECT precio FROM productos WHERE id=47";
    ...
    <div class="col">
      <a href="../templatesJuegos/juegoPlayStation.php?lang=es&idJ=50" style="text-decoration: none;">
            ...
            <ul class="d-flex list-unstyled mt-auto">
              ...
              <li class="d-flex align-items-center me-3">
                ...
                <?php
                  require '../includes/dbh.inc.php';
                  $stmt = mysqli_stmt_init($conn);
                  $sql = "SELECT nombrejuego FROM productos WHERE id=50";
                  mysqli_stmt_prepare($stmt, $sql);
                  mysqli_stmt_execute($stmt);
                  $resultado = mysqli_stmt_get_result($stmt);
                  while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
              ...
              <li class="d-flex align-items-center">
                <small class="bg-dark text-white rounded-5"><?php
                          ...
                          require '../includes/dbh.inc.php';
                          $stmt = mysqli_stmt_init($conn);
                          $sql = "SELECT precio FROM productos WHERE id=50";
    ...
    <div class="col">
      <a href="../templatesJuegos/juegoPlayStation.php?lang=es&idJ=52" style="text-decoration: none;">
            ...
            <ul class="d-flex list-unstyled mt-auto">
              ...
              <li class="d-flex align-items-center me-3">
                ...
                <?php
                  require '../includes/dbh.inc.php';
                  $stmt = mysqli_stmt_init($conn);
                  $sql = "SELECT nombrejuego FROM productos WHERE id=52";
                  mysqli_stmt_prepare($stmt, $sql);
                  mysqli_stmt_execute($stmt);
                  $resultado = mysqli_stmt_get_result($stmt);
                  while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
              ...
              <li class="d-flex align-items-center">
                <small class="bg-dark text-white rounded-5"><?php
                          ...
                          require '../includes/dbh.inc.php';
                          $stmt = mysqli_stmt_init($conn);
                          $sql = "SELECT precio FROM productos WHERE id=52";
...
<div class="container px-4" id="custom-cards">
  ...
  <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
    <div class="col">
      <a href="../templatesJuegos/juegoPlayStation.php?lang=es&idJ=41" style="text-decoration: none;">
            ...
            <ul class="d-flex list-unstyled mt-auto">
              ...
              <li class="d-flex align-items-center me-3">
                ...
                <?php
                  require '../includes/dbh.inc.php';
                  $stmt = mysqli_stmt_init($conn);
                  $sql = "SELECT nombrejuego FROM productos WHERE id=41";
                  mysqli_stmt_prepare($stmt, $sql);
                  mysqli_stmt_execute($stmt);
                  $resultado = mysqli_stmt_get_result($stmt);
                  while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
              ...
              <li class="d-flex align-items-center">
                <small class="bg-dark text-white rounded-5"><?php
                          ...
                          require '../includes/dbh.inc.php';
                          $stmt = mysqli_stmt_init($conn);
                          $sql = "SELECT precio FROM productos WHERE id=41";
    ...
    <div class="col">
      <a href="../templatesJuegos/juegoPlayStation.php?lang=es&idJ=36" style="text-decoration: none;">
            ...
            <ul class="d-flex list-unstyled mt-auto">
              ...
              <li class="d-flex align-items-center me-3">
                ...
                <?php
                  require '../includes/dbh.inc.php';
                  $stmt = mysqli_stmt_init($conn);
                  $sql = "SELECT nombrejuego FROM productos WHERE id=36";
                  mysqli_stmt_prepare($stmt, $sql);
                  mysqli_stmt_execute($stmt);
                  $resultado = mysqli_stmt_get_result($stmt);
                  while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
              ...
              <li class="d-flex align-items-center">
                <small class="bg-dark text-white rounded-5"><?php
                          ...
                          require '../includes/dbh.inc.php';
                          $stmt = mysqli_stmt_init($conn);
                          $sql = "SELECT precio FROM productos WHERE id=36";
    ...
    <div class="col">
      <a href="../templatesJuegos/juegoPlayStation.php?lang=es&idJ=51" style="text-decoration: none;">
            ...
            <ul class="d-flex list-unstyled mt-auto">
              ...
              <li class="d-flex align-items-center me-3">
                ...
                <?php
                  require '../includes/dbh.inc.php';
                  $stmt = mysqli_stmt_init($conn);
                  $sql = "SELECT nombrejuego FROM productos WHERE id=51";
                  mysqli_stmt_prepare($stmt, $sql);
                  mysqli_stmt_execute($stmt);
                  $resultado = mysqli_stmt_get_result($stmt);
                  while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
              ...
              <li class="d-flex align-items-center">
                <small class="bg-dark text-white rounded-5"><?php
                          ...
                          require '../includes/dbh.inc.php';
                          $stmt = mysqli_stmt_init($conn);
                          $sql = "SELECT precio FROM productos WHERE id=51";
