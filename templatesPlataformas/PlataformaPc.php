          ...
          <h4 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">
            ...
            <ul class="d-flex list-unstyled mt-auto">
              ...
              while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
                foreach ($fila as $f) {
                  if ($f < 1) {
                    echo '<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="red" class="bi bi-pc-display naranjilla" viewBox="0 0 16 16">
            ...
            <path d="M8 1a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1V1Zm1 13.5a.5.5 0 1 0 1 0 .5.5 0 0 0-1 0Zm2 0a.5.5 0 1 0 1 0 .5.5 0 0 0-1 0ZM9.5 1a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5ZM9 3.5a.5.5 0 0 0 .5.5h5a.5.5 0 0 0 0-1h-5a.5.5 0 0 0-.5.5ZM1.5 2A1.5 1.5 0 0 0 0 3.5v7A1.5 1.5 0 0 0 1.5 12H6v2h-.5a.5.5 0 0 0 0 1H7v-4H1.5a.5.5 0 0 1-.5-.5v-7a.5.5 0 0 1 .5-.5H7V2H1.5Z" />
              ...
              <li class="d-flex align-items-center me-3">
                <small class="bg-dark text-white rounded-5">
                  ...
                  require '../includes/dbh.inc.php';
                  $stmt = mysqli_stmt_init($conn);
                  $sql = "SELECT nombrejuego FROM productos WHERE id=1";
                  mysqli_stmt_prepare($stmt, $sql);
                  mysqli_stmt_execute($stmt);
                  $resultado = mysqli_stmt_get_result($stmt);
                  while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
              ...
              <li class="d-flex align-items-center">
                <small class="bg-dark text-white rounded-5">
                  ...
                  require '../includes/dbh.inc.php';
                  $stmt = mysqli_stmt_init($conn);
                  $sql = "SELECT precio FROM productos WHERE id=1";
          ...
          <ul class="d-flex list-unstyled mt-auto">
            ...
            <li class="d-flex align-items-center me-3">
              <small class="bg-dark text-white rounded-5">
                ...
                require '../includes/dbh.inc.php';
                $stmt = mysqli_stmt_init($conn);
                $sql = "SELECT nombrejuego FROM productos WHERE id=10";
                mysqli_stmt_prepare($stmt, $sql);
                mysqli_stmt_execute($stmt);
                $resultado = mysqli_stmt_get_result($stmt);
                while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
            ...
            <li class="d-flex align-items-center">
              <small class="bg-dark text-white rounded-5">
                ...
                require '../includes/dbh.inc.php';
                $stmt = mysqli_stmt_init($conn);
                $sql = "SELECT precio FROM productos WHERE id=10";
          ...
          <ul class="d-flex list-unstyled mt-auto">
            ...
            <li class="d-flex align-items-center me-3">
              <small class="bg-dark text-white rounded-5">
                ...
                require '../includes/dbh.inc.php';
                $stmt = mysqli_stmt_init($conn);
                $sql = "SELECT nombrejuego FROM productos WHERE id=5";
                mysqli_stmt_prepare($stmt, $sql);
                mysqli_stmt_execute($stmt);
                $resultado = mysqli_stmt_get_result($stmt);
                while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
            ...
            <li class="d-flex align-items-center">
              <small class="bg-dark text-white rounded-5">
                ...
                require '../includes/dbh.inc.php';
                $stmt = mysqli_stmt_init($conn);
                $sql = "SELECT precio FROM productos WHERE id=5";
          ...
          <ul class="d-flex list-unstyled mt-auto">
            ...
            <li class="d-flex align-items-center me-3">
              <small class="bg-dark text-white rounded-5">
                ...
                require '../includes/dbh.inc.php';
                $stmt = mysqli_stmt_init($conn);
                $sql = "SELECT nombrejuego FROM productos WHERE id=55";
                mysqli_stmt_prepare($stmt, $sql);
                mysqli_stmt_execute($stmt);
                $resultado = mysqli_stmt_get_result($stmt);
                while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
            ...
            <li class="d-flex align-items-center">
              <small class="bg-dark text-white rounded-5">
                ...
                require '../includes/dbh.inc.php';
                $stmt = mysqli_stmt_init($conn);
                $sql = "SELECT precio FROM productos WHERE id=55";
          ...
          <ul class="d-flex list-unstyled mt-auto">
            ...
            <li class="d-flex align-items-center me-3">
              <small class="bg-dark text-white rounded-5">
                ...
                require '../includes/dbh.inc.php';
                $stmt = mysqli_stmt_init($conn);
                $sql = "SELECT nombrejuego FROM productos WHERE id=6";
                mysqli_stmt_prepare($stmt, $sql);
                mysqli_stmt_execute($stmt);
                $resultado = mysqli_stmt_get_result($stmt);
                while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
            ...
            <li class="d-flex align-items-center">
              <small class="bg-dark text-white rounded-5">
                ...
                require '../includes/dbh.inc.php';
                $stmt = mysqli_stmt_init($conn);
                $sql = "SELECT precio FROM productos WHERE id=6";
          ...
          <ul class="d-flex list-unstyled mt-auto">
            ...
            <li class="d-flex align-items-center me-3">
              <small class="bg-dark text-white rounded-5">
                ...
                require '../includes/dbh.inc.php';
                $stmt = mysqli_stmt_init($conn);
                $sql = "SELECT nombrejuego FROM productos WHERE id=3";
                mysqli_stmt_prepare($stmt, $sql);
                mysqli_stmt_execute($stmt);
                $resultado = mysqli_stmt_get_result($stmt);
                while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
            ...
            <li class="d-flex align-items-center">
              <small class="bg-dark text-white rounded-5">
                ...
                require '../includes/dbh.inc.php';
                $stmt = mysqli_stmt_init($conn);
                $sql = "SELECT precio FROM productos WHERE id=3";
          ...
          <ul class="d-flex list-unstyled mt-auto">
            ...
            <li class="d-flex align-items-center me-3">
              <small class="bg-dark text-white rounded-5">
                ...
                require '../includes/dbh.inc.php';
                $stmt = mysqli_stmt_init($conn);
                $sql = "SELECT nombrejuego FROM productos WHERE id=4";
                mysqli_stmt_prepare($stmt, $sql);
                mysqli_stmt_execute($stmt);
                $resultado = mysqli_stmt_get_result($stmt);
                while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
            ...
            <li class="d-flex align-items-center">
              <small class="bg-dark text-white rounded-5">
                ...
                require '../includes/dbh.inc.php';
                $stmt = mysqli_stmt_init($conn);
                $sql = "SELECT precio FROM productos WHERE id=4";
          ...
          <ul class="d-flex list-unstyled mt-auto">
            ...
            <li class="d-flex align-items-center me-3">
              <small class="bg-dark text-white rounded-5">
                ...
                require '../includes/dbh.inc.php';
                $stmt = mysqli_stmt_init($conn);
                $sql = "SELECT nombrejuego FROM productos WHERE id=9";
                mysqli_stmt_prepare($stmt, $sql);
                mysqli_stmt_execute($stmt);
                $resultado = mysqli_stmt_get_result($stmt);
                while ($fila = $resultado->fetch_array(MYSQLI_NUM)) {
            ...
            <li class="d-flex align-items-center">
              <small class="bg-dark text-white rounded-5">
                ...
                require '../includes/dbh.inc.php';
                $stmt = mysqli_stmt_init($conn);
                $sql = "SELECT precio FROM productos WHERE id=9";
